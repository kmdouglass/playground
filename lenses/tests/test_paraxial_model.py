...
def test_system():
    surf_0 = Surface(diameter=25, radius_of_curvature=inf, surface_type=SurfaceType.OBJECT)
    gap_0 = Gap(refractive_index=1.0, thickness=-inf)
    surf_1 = Surface(diameter=25, radius_of_curvature=25.8, surface_type=SurfaceType.REFRACTING_SPHERE)
    gap_1 = Gap(refractive_index=1.5, thickness=5.3)
    surf_2 = Surface(diameter=25, radius_of_curvature=inf, surface_type=SurfaceType.IMAGE)
...
def test_system_model_first_element_not_object_surface():
    surf_0 = Surface(diameter=25, radius_of_curvature=inf, surface_type=SurfaceType.REFRACTING_SPHERE)
    gap_0 = Gap(refractive_index=1.0, thickness=-inf)
    surf_1 = Surface(diameter=25, radius_of_curvature=25.8, surface_type=SurfaceType.REFRACTING_SPHERE)
    gap_1 = Gap(refractive_index=1.5, thickness=5.3)
    surf_2 = Surface(diameter=25, radius_of_curvature=inf, surface_type=SurfaceType.IMAGE)
...
def test_system_model_last_element_not_image_surface():
    ...
    surf_1 = Surface(diameter=25, radius_of_curvature=25.8, surface_type=SurfaceType.REFRACTING_SPHERE)
    gap_1 = Gap(refractive_index=1.5, thickness=5.3)
    surf_2 = Surface(diameter=25, radius_of_curvature=inf, surface_type=SurfaceType.REFRACTING_SPHERE)
