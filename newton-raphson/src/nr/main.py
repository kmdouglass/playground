...
def newton_raphson(
    ...
    x, y, z = (
        pos[0] + s * dir_cosines[0],
        pos[1] + s * dir_cosines[1],
        pos[2] + s * dir_cosines[2],
    )
...
def main():
    ...
    dir_cosines = np.array(
        [0.0, 0.7071, 0.7071], dtype=Float
    )  # Ray traveling at 45 degrees to the z axis
    surface = FlatSurface()
